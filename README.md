...
1. clone this repository: `git clone https://github.com/robertbene/getting-cleaning-data-project.git`
...
In the repository root directory you find the file `TidyDataSet.txt` with the tidy data set.
